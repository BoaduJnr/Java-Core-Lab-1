package AdvancedDataStructures.Graph.DijkstraAlgorithm;
...
public class Graph<T> {
    ...
    public static void main(String[] args) {
        Vertex<String> A = new Vertex<>("Town hall");
        Vertex<String> B = new Vertex<>("Library");
        Vertex<String> C = new Vertex<>("School");
        Vertex<String> D = new Vertex<>("Supermarket");
